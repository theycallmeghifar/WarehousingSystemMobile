...
public class ScanPurchaseOrderBarangMasukActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_purchase_order_barang_masuk);
        initViews();
    ...
    private void initViews() {
        txtBarcodeValue = findViewById(R.id.txtQRPurchaseOrderBarangMasuk);
        surfaceView = findViewById(R.id.surfaceViewPurchaseOrderBarangMasuk);
    }
...
//        Toast.makeText(getApplicationContext(), "Silahkan Scan Barang", Toast.LENGTH_SHORT).show();
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(ScanPurchaseOrderBarangMasukActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(ScanPurchaseOrderBarangMasukActivity.this, new
                ...
                if (barcodes.size() != 0) {
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            editor.putString("purchaseOrder", intentData);
                            editor.commit();

                            Intent i = new Intent(ScanPurchaseOrderBarangMasukActivity.this, DetailScanBarangMasukActivity.class);
                            startActivity(i);
