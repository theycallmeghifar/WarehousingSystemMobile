...
public class ScanRakBarangKeluarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvPaletId = prefDetailBarangKeluarListView.getString("lvIdPalet",null);
...
//        Toast.makeText(getApplicationContext(), "Silahkan Scan Barang", Toast.LENGTH_SHORT).show();
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(ScanRakBarangKeluarActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(ScanRakBarangKeluarActivity.this, new
...
//                Toast.makeText(getApplicationContext(), "Berhasil discan", Toast.LENGTH_SHORT).show();
    ...
    public void getPalet(String idPalet, String idPaletRequired) {

        ApiEndPoint apiEndPoint = ApiClient.getClient().create(ApiEndPoint.class);
        Call<PaletTempResponse> call = apiEndPoint.getPalet(idPalet, idPaletRequired);
        ...
        call.enqueue(new Callback<PaletTempResponse>() {
            ...
            public void onResponse(Call<PaletTempResponse> call, Response<PaletTempResponse> response) {
                ...
                if (itemResponse.getResponses()) {
                    ...
                    if (lvPaletId.equals(itemResponse.getIdPalet())){
                        ...
                        Intent i = new Intent(ScanRakBarangKeluarActivity.this, KonfirmasiBarangKeluarActivity.class);
                        startActivity(i);
